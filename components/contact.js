            ...
            <form onSubmit={handleSubmit}> 
                <div className="mb-6"> 
                    ...
                    onChange={handleInputChange} ></textarea> </div> <div className="text-center"> 
                                ...
                                <div className="mt-12 text-center"> <p className="text-gray-600">Or reach us directly:</p> <p className="font-semibold text-gray-800">Phone: 937-819-6452</p> <p className="font-semibold text-gray-800">Email: contact@icareerrand.org</p> </div>
     </section> 
  )
}
